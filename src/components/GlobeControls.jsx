const LAYER_LABELS = ['Plain', 'Borders', 'Capitals', 'Cities'];

export default function GlobeControls({ onZoomIn, onZoomOut, onReset, onToggleLayers, layerMode = 0 }) {
  const layerActive = layerMode > 0;
  ...
  return (
    <div className="globe-controls">
      ...
      {/* Layer toggle – cycles Plain → Borders → Capitals → Cities → Plain */}
      <button
        className={`ctrl-btn ctrl-divider${layerActive ? ' ctrl-btn-layer-active' : ''}`}
